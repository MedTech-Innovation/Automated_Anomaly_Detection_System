...
from utils.img_processing import modality_and_ground_truth_processing, predicted_seg_processing, display_specific_class
from utils.variables import modalities_dict, samples_test
from utils.predict_seg import patient_has_changed_update_token, get_selected_patient_path, predict_btn_click
from utils.utils import get_key_from_dict, create_colormap, download_file
...
def launch_app(model):
    ...
    with col5:
        ...
        download_file(fig1, st.session_state["patient_path"], selected_plane, selected_slice, 5)
    ...
    with col6:
        if st.session_state["pred_can_be_displayed"]:
            ...
            download_file(fig2, st.session_state["patient_path"], selected_plane, selected_slice, 6)
